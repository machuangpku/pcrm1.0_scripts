...
all_config=list([
[range(0,1),range(0,15),range(0,4)],
[range(0,1),range(0,15),range(4,6)],
[range(1,2),range(0,15),range(0,2)],
[range(1,2),range(0,15),range(2,4)],
[range(1,2),range(0,15),range(4,6)],
[range(2,3),range(0,15),range(0,2)],
[range(2,3),range(0,15),range(2,4)],
