...
for num in num_list:
	...
	for name3 in r_lst:
		...
		mySheet.Cells(pc, 15).Value = points-C1_points[num]
		...
		mySheet.Cells(pc, 22).Value = Y
		mySheet.Cells(pc, 23).Value = U
		mySheet.Cells(pc, 24).Value = V
		
		mySheet.Cells(pc, 26).Value = time
		mySheet.Cells(pc, 27).Value = time2
		
		mySheet.Cells(pc, 30).Value = MSEh/64
